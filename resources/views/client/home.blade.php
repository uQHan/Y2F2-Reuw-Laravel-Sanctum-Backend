...
<div class="card mt-2 border-0 text-start">
   ...
   <form action="/post" enctype="multipart/form-data" method="POST">
      ...
      <div class="card-body">
         ...
         <div>
            <textarea name="postText" class="form-control" id="" rows="3"
...
@else
<div class="card mt-2 border-5 d-flex justify-content-center align-items-center btn btn-outline-light" style="height: 200px">
